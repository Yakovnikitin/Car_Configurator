...
//	}
	...
	function withIndexedDB(db) {
		...
		var mainCompiledCode = fetchFromIndexedDB(db, 'wasmModule').then(function(wasmModule) {
			...
			return download(Module.locateFile('https://dl.dropboxusercontent.com/s/eo3qs56kdqcrm43/UE4Game.wasm?dl=0'), 'arraybuffer').then(function(wasmBytes) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/Yakovnikitin/Car_Configurator/362a4ade8a9237013388300a766f3d111618a02d/FirstVar.data.js'));
		var utilityJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/Yakovnikitin/Car_Configurator/8d5158759f7b89053b919fe521d23b2226cc68ab/Utility.js')).then(addScriptToDom);
		var dataDownload =
